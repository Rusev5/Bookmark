...
public class MainActivity extends AppCompatActivity implements OnItemSwipeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.llStatusBar.setMinimumHeight(ImmersionBar.getStatusBarHeight(this));
    ...
    private void initPageView() {
        ...
        urlAdapter.setEmptyView(R.layout.include_empty_view,
                (ViewGroup) binding.rvMain.getParent());
        ...
        mItemTouchHelper.attachToRecyclerView(binding.rvMain);

        binding.rvMain.setLayoutManager(new LinearLayoutManager(this));
        binding.rvMain.setAdapter(urlAdapter);
    ...
    public void initViewListener() {
        ...
        urlAdapter.setOnItemClickListener((adapter, view, position) -> {
            if (binding.swchMainEdit.isChecked()) {
